<script type="text/javascript">
  ...
  compareResultDiv += '  <div class="back compareText"><strong><?php echo COMPARE_DEFAULT; ?></strong> <?php echo COMPARE_COUNT_START . COMPARE_PRODUCTS_VALUE_COUNT . COMPARE_COUNT_END; ?></div>' + "\n";
